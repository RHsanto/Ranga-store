// load products function and all products dada here 
const loadProducts = () => {
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p><i class="fas fa-star"></i> <strong> ${product.rating.rate}</strong> Rating By <i class="fas fa-user"></i> <strong>${product.rating.count}</strong> People </p>
